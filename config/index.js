...
// assuming this file is named "index.js" and lives in subdirectory named "config" of the app root.

let config;
const configFile = `./${process.env.NODE_ENV ? process.env.NODE_ENV : 'development'}.js`;
